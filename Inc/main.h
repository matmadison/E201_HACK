...
#define ENC_Z_EXTI_IRQn EXTI2_IRQn
#define LED_USB_RED_Pin GPIO_PIN_6
#define LED_USB_RED_GPIO_Port GPIOA
#define LED_USB_GREEN_Pin GPIO_PIN_7
#define LED_USB_GREEN_GPIO_Port GPIOA
#define ENCODER_CURRENT_SENSE_Pin GPIO_PIN_13
#define ENCODER_CURRENT_SENSE_GPIO_Port GPIOB
#define LED_ENCODER_GREEN_Pin GPIO_PIN_8
#define LED_ENCODER_GREEN_GPIO_Port GPIOA
#define LED_ENCODER_RED_Pin GPIO_PIN_9
#define LED_ENCODER_RED_GPIO_Port GPIOA
